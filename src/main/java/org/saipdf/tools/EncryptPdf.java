 ...
 */
package org.saipdf.tools;

import java.io.FileOutputStream;
import java.util.HashMap;

import org.saipdf.text.pdf.PdfEncryptor;
...
public class EncryptPdf {
	...
	private final static int permit[] = { PdfWriter.ALLOW_PRINTING, PdfWriter.ALLOW_MODIFY_CONTENTS, PdfWriter.ALLOW_COPY, PdfWriter.ALLOW_MODIFY_ANNOTATIONS,
			PdfWriter.ALLOW_FILL_IN, PdfWriter.ALLOW_SCREENREADERS, PdfWriter.ALLOW_ASSEMBLY, PdfWriter.ALLOW_DEGRADED_PRINTING };
	...
	public static void main(String args[]) {
		...
		try {
			...
			PdfEncryptor.encrypt(reader, new FileOutputStream(args[OUTPUT_FILE]), args[USER_PASSWORD].getBytes(), args[OWNER_PASSWORD].getBytes(), permissions,
