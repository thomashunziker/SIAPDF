...
public class ToolboxAvailable {
	...
	public static void main(String[] args) {
		if (GraphicsEnvironment.isHeadless()) {
			...
			try {
				Class c = Class.forName("org.saipdf.toolbox.Toolbox");
				Method toolboxMain = c.getMethod("main", new Class[] { args.getClass() });
				toolboxMain.invoke(null, new Object[] { args });
			} catch (Exception e) {
				JOptionPane.showMessageDialog(null, "You need the iText-toolbox.jar with class org.saipdf.toolbox.Toolbox to use the iText Toolbox.",
