...
public class BuildTutorial {
	 ...
	 *            <ul>
	 *            <li>a sourcedirectory (root of the tutorial xml-files),
	 *            <li>a destination directory (where the html and build.xml
	 *            files will be generated),
	 *            <li>an xsl to transform the index.xml into a build.xml
	 *            <li>an xsl to transform the index.xml into am index.html
	 *            </ul>
	 */
	...
	/**
	 * Inspects a file or directory that is given and performs the necessary
	 * actions on it (transformation or recursion).
	 * 
	 * @param source
	 *            a sourcedirectory (possibly with a tutorial xml-file)
	 * @param destination
	 *            a destination directory (where the html and build.xml file
	 ...
	 * @throws IOException
	 *             when something goes wrong while reading or creating a file or
	 *             directory
	 */
