...
/**
 * A <CODE>Paragraph</CODE> is a series of <CODE>Chunk</CODE>s and/or
 * <CODE>Phrases</CODE>.
 * <P>
 * A <CODE>Paragraph</CODE> has the same qualities of a <CODE>Phrase</CODE>, but
 * also some additional layout-parameters:
 * <UL>
 * <LI>the indentation
...
public class Paragraph extends Phrase {
	...
	/**
	 * Constructs a <CODE>Paragraph</CODE> with a certain <CODE>Chunk</CODE> and
	 * a certain leading.
	 * 
	 * @param leading
	 *            the leading
	...
	/**
	 * Constructs a <CODE>Paragraph</CODE> with a certain leading,
	 * <CODE>String</CODE> and <CODE>Font</CODE>.
	 * 
	 * @param leading
	 *            the leading
	 * @param string
	...
	/**
	 * @see org.saipdf.text.Phrase#setLeading(float)
	 */
	 ...
	 * multipliedLeading*maxFontSize where maxFontSize is the size of the
	...
	/**
	 * Gets the total leading. This method is based on the assumption that the
	 * font of the Paragraph is the font of all the elements that make part of
	 * the paragraph. This isn't necessarily true.
	 * 
