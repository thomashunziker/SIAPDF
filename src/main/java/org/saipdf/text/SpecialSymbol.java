 ...
 * <P>
 * When you construct a <CODE>Phrase</CODE> with Phrase.getInstance using a
 * <CODE>String</CODE>, this <CODE>String</CODE> can contain special Symbols.
 * These are characters with an int value between 913 and 937 (except 930) and
 * between 945 and 969. With this class the value of the corresponding character
 * of the Font Symbol, can be retrieved.
 * 
 * @see Phrase
 * 
