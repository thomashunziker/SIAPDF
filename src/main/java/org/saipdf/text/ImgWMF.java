...
import org.saipdf.text.pdf.codec.wmf.InputMeta;
import org.saipdf.text.pdf.codec.wmf.MetaDo;


/**
 * An <CODE>ImgWMF</CODE> is the representation of a windows metafile that has
...
public class ImgWMF extends Image {
	 ...
	 * 
	 * @param filename
	 *            a <CODE>String</CODE>-representation of the file that contains
	 *            the image.
	 * @throws BadElementException
	 *             on error
	...
	/**
	 * This method checks if the image is a valid WMF and processes some
	 * parameters.
	 * 
	 * @throws BadElementException
	 * @throws IOException
