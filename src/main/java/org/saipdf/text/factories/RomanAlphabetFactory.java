...
/**
 * This class can produce String combinations representing a number. "a" to "z"
 * represent 1 to 26, "AA" represents 27, "AB" represents 28, and so on; "ZZ" is
 * followed by "AAA".
 */
public class RomanAlphabetFactory {

	/**
	 * Translates a positive integer (not equal to zero) into a String using the
	 * letters 'a' to 'z'; 1 = a, 2 = b, ..., 26 = z, 27 = aa, 28 = ab,...
	 */
	...
	/**
	 * Translates a positive integer (not equal to zero) into a String using the
	 * letters 'a' to 'z' (a = 1, b = 2, ..., z = 26, aa = 27, ab = 28,...).
	 */
