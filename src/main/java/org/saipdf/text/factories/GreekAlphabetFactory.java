...
import org.saipdf.text.SpecialSymbol;

/**
 * This class can produce String combinations representing a number built with
 * Greek letters (from alpha to omega, then alpha alpha, alpha beta, alpha
 * gamma). We are aware of the fact that the original Greek numbering is
 * different; See
 * http://www.cogsci.indiana.edu/farg/harry/lan/grknum.htm#ancient but this
 * isn't implemented yet; the main reason being the fact that we need a font
 * that has the obsolete Greek characters qoppa and sampi.
 * 
