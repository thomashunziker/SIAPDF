...
/**
 * This is an <CODE>Element</CODE> that contains some meta information about the
 * document.
 * <P>
 * An object of type <CODE>Meta</CODE> can not be constructed by the user. User
 * defined meta information should be placed in a <CODE>Header</CODE>-object.
...
public class Meta implements Element {
	 ...
	 * 
	 * @param tag
	 *            iText tag for meta information
