...
/**
 * A <CODE>Row</CODE> is part of a <CODE>Table</CODE> and contains some
 * <CODE>Cells</CODE>.
 * <P>
 * All <CODE>Row</CODE>s are constructed by a <CODE>Table</CODE>-object. You
 * don't have to construct any <CODE>Row</CODE> yourself. In fact you can't
 * construct a <CODE>Row</CODE> outside the package.
 * <P>
 * Since a <CODE>Cell</CODE> can span several rows and/or columns a row can
 * contain reserved space without any content.
 * 
 * @see Element
 * @see Cell
 * @see Table
...
public class Row implements Element {
	...
	/**
	 * Constructs a <CODE>Row</CODE> with a certain number of
	 * <VAR>columns</VAR>.
	 * 
	 * @param columns
	 *            a number of columns
	...
	/**
	 * Returns a <CODE>Row</CODE> that is a copy of this <CODE>Row</CODE> in
	 * which a certain column has been deleted.
	 * 
	 * @param column
	 ...
	 * @return the column position the <CODE>Cell</CODE> was added, or
	 *         <CODE>-1</CODE> if the <CODE>element</CODE> couldn't be added.
	 */
	 ...
	 * @return the column position the <CODE>Cell</CODE> was added, or
	 *         <CODE>-1</CODE> if the <CODE>Cell</CODE> couldn't be added.
	 */
	...
	/**
	 * Puts <CODE>Cell</CODE> to the <CODE>Row</CODE> at the position given,
	 * doesn't reserve colspan.
	 * 
	 * @param aElement
	 *            the cell to add.
	 * @param column
	 ...
	 * @return <CODE>true</CODE> if the column was reserved, <CODE>false</CODE>
	 *         if not.
	 */
	...
	/**
	 * Returns true/false when this position in the <CODE>Row</CODE> has been
	 * reserved, either filled or through a colspan of an Element.
	 * 
	 * @param column
	 *            the column.
	 * @return <CODE>true</CODE> if the column was reserved, <CODE>false</CODE>
	 ...
	 * 
	 * @param element
	 *            the object of which you'd like to know the type-id, -1 if
	 *            invalid
	 ...
	 * 
	 * @param column
	 *            the column the <CODE>Cell/Table</CODE> is in.
	 * @return the <CODE>Cell</CODE>,<CODE>Table</CODE> or <VAR>Object</VAR> if
	 *         the column was reserved or null if empty.
	 */
	public Object getCell(int column) {
		if ((column < 0) || (column > columns)) {
			throw new IndexOutOfBoundsException(MessageLocalization.getComposedMessage("getcell.at.illegal.index.1.max.is.2", String.valueOf(column),
