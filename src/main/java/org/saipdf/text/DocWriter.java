...
import org.saipdf.text.pdf.OutputStreamCounter;


/**
 * An abstract <CODE>Writer</CODE> class for documents.
 * <P>
 * <CODE>DocWriter</CODE> is the abstract class of several writers such as
 * <CODE>PdfWriter</CODE> and <CODE>HtmlWriter</CODE>. A <CODE>DocWriter</CODE>
 * can be added as a <CODE>DocListener</CODE> to a certain <CODE>Document</CODE>
 * by getting an instance (see method <CODE>getInstance()</CODE> in the specific
 * writer-classes). Every <CODE>Element</CODE> added to the original
 * <CODE>Document</CODE> will be written to the <CODE>OutputStream</CODE> of the
 * listening <CODE>DocWriter</CODE>.
 * 
 * @see Document
 * @see DocListener
 */
...
public abstract class DocWriter implements DocListener {
	 ...
	 * 
	 * @return <CODE>true</CODE> if writing temporarily has to be paused,
	 ...
	 * <CODE>MarkupAttributes</CODE> object to the <CODE>OutputStream</CODE>.
	 * 
	 * @param markup
	 *            a <CODE>Properties</CODE> collection to write.
