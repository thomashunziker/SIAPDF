...
public class ElementTags {
	...
	/**
	 * attribute of the root and annotation tag (also a special tag within a
	 * chapter or section)
	 */
	...
	/**
	 * Translates a String value to an alignment value. (written by Norman
	 * Richards, integrated into iText by Bruno)
	 * 
	 * @param alignment
	 *            a String (one of the ALIGN_ constants of this class)
	 * @return an alignment value (one of the ALIGN_ constants of the Element
	 *         interface)
	 */
