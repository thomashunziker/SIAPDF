...
package org.saipdf.text.pdf.hyphenation;
...
public class HyphenationTree extends TernaryTree implements PatternConsumer {
	 ...
	 * {@link SimplePatternParser SimplePatternParser} as callback to add
	 * character classes. Character classes define the valid word characters for
	 * hyphenation. If a word contains a character not defined in any of the
	 * classes, it is not hyphenated. It also defines a way to normalize the
	 * characters in order to compare them with the stored patterns. Usually
	 * pattern files use only lower case characters, in this case a class for
	 * letter 'a', for example, should be defined as "aA", the first character
	...
	/**
	 * Add an exception to the tree. It is used by {@link SimplePatternParser
	 * SimplePatternParser} class as callback to store the hyphenation
	 * exceptions.
	 * 
	 * @param word
	 *            normalized word
	 ...
	 * {@link SimplePatternParser SimplePatternParser} class as callback to add
	 * a pattern to the tree.
	 * 
	 * @param pattern
