 ...
 * One, defined in CCITT X.208 or ISO/IEC 8824). A date is a
 * <CODE>PdfString</CODE> of the form:
 * <P>
 * <BLOCKQUOTE> (D:YYYYMMDDHHmmSSOHH'mm') </BLOCKQUOTE>
 * <P>
 * This object is described in the 'Portable Document Format Reference Manual
 * version 1.3' section 7.2 (page 183-184)
 * 
 * @see PdfString
...
public class PdfDate extends PdfString {
	...
	private static final int DATE_SPACE[] = { Calendar.YEAR, 4, 0, Calendar.MONTH, 2, -1, Calendar.DAY_OF_MONTH, 2, 0, Calendar.HOUR_OF_DAY, 2, 0,
			Calendar.MINUTE, 2, 0, Calendar.SECOND, 2, 0 };
	 ...
	 * 
	 * @param d
	 *            the date that has to be turned into a <CODE>PdfDate</CODE>
	 *            -object
	 */
	...
	/**
	 * Constructs a <CODE>PdfDate</CODE>-object, representing the current day
	 * and time.
	 */
	...
	/**
	 * Adds a number of leading zeros to a given <CODE>String</CODE> in order to
	 * get a <CODE>String</CODE> of a certain length.
	 * 
	 * @param i
	 *            a given number
	 * @param length
	 *            the length of the resulting <CODE>String</CODE>
	 * @return the resulting <CODE>String</CODE>
	 */

	private String setLength(int i, int length) { // 1.3-1.4 problem fixed by
													// Finn Bock
	 ...
	 * @return a <CODE>Calendar</CODE> representing the date or
	 *         <CODE>null</CODE> if the string was not a date
	 */
