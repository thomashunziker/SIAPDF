...
import org.saipdf.text.exceptions.BadPasswordException;
...
import org.saipdf.text.xml.xmp.XmpReader;
...
class PdfStamperImp extends PdfWriter {
	...
	/**
	 * @see org.saipdf.text.pdf.PdfWriter#getPageReference(int)
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfWriter#addAnnotation(org.saipdf.text.pdf.PdfAnnotation)
	 */
						...
						if (rect != null && (rect.left() != 0 || rect.right() != 0 || rect.top() != 0 || rect.bottom() != 0)) {
							...
							case 90:
								annot.put(PdfName.RECT,
										new PdfRectangle(pageSize.getTop() - rect.top(), rect.right(), pageSize.getTop() - rect.bottom(), rect.left()));
								break;
							case 180:
								annot.put(
										PdfName.RECT,
	...
	/**
	 * @see org.saipdf.text.pdf.PdfWriter#setOpenAction(org.saipdf.text.pdf.PdfAction)
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfWriter#setOpenAction(java.lang.String)
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfWriter#setThumbnail(org.saipdf.text.Image)
	 */
	public void setThumbnail(org.saipdf.text.Image image) {
