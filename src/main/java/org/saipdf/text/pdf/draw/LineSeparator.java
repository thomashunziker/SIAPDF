...
/**
 * Element that draws a solid line from left to right. Can be added directly to
...
public class LineSeparator extends VerticalPositionMark {
	 ...
	 *            the thickness of the line
	 * @param percentage
	 *            the width of the line as a percentage of the available page
	 *            width
	 * @param lineColor
	 *            the color of the line
	 * @param align
	 *            the alignment
	 * @param offset
	 *            the offset of the line relative to the current baseline
	 *            (negative = under the baseline)
	 */
