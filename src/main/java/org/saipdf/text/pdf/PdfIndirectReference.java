...
/**
 * <CODE>PdfIndirectReference</CODE> contains a reference to a
 * <CODE>PdfIndirectObject</CODE>.
 * <P>
 * Any object used as an element of an array or as a value in a dictionary may
 * be specified by either a direct object of an indirect reference. An
 * <I>indirect reference</I> is a reference to an indirect object, and consists
 * of the indirect object's object number, generation number and the <B>R</B>
 * keyword.<BR>
 * This object is described in the 'Portable Document Format Reference Manual
 * version 1.3' section 4.11 (page 54).
 * 
 * @see PdfObject
...
public class PdfIndirectReference extends PdfObject {
	 ...
	 * 
	 * @param type
	 *            the type of the <CODE>PdfObject</CODE> that is referenced to
	 * @param number
	 *            the object number.
	 * @param generation
	 *            the generation number.
