...
/**
 * Each font in the document will have an instance of this class where the
 * characters used will be represented.
 * 
...
class FontDetails {
	...
	/**
	 * Each font used in a document has an instance of this class. This class
	 * stores the characters used in the document and other specifics unique to
	...
	/**
	 * Converts the text into bytes to be placed in the document. The conversion
	 * is done according to the font and the encoding and the characters used
	 * are stored.
	 * 
	 * @param text
	 *            the text to convert
	 ...
	 * 
	 * @param writer
	 *            the <CODE>PdfWriter</CODE> of this document
	 */
	...
	/**
	 * Indicates if all the glyphs and widths for that particular encoding
	 * should be included in the document. Set to <CODE>false</CODE> to include
	 * all.
	 * 
	 * @param subset
