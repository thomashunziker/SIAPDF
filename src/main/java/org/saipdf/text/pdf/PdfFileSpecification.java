...
import org.saipdf.text.pdf.collection.PdfCollectionItem;
...
public class PdfFileSpecification extends PdfDictionary {
	...
	/**
	 * Creates a new instance of PdfFileSpecification. The static methods are
	 * preferred.
	 */
	...
	/**
	 * Creates a file specification with the file embedded. The file may come
	 * from the file system or from a byte array. The data is flate compressed.
	 * 
	 * @param writer
	 *            the <CODE>PdfWriter</CODE>
	 * @param filePath
	 ...
	 *            the compression level to be used for compressing the file it
	 *            takes precedence over <CODE>filePath</CODE>
	 * @throws IOException
	 *             on error
	 * @return the file specification
	 * @since 2.1.3
	...
	/**
	 * Creates a file specification with the file embedded. The file may come
	 * from the file system or from a byte array.
	 * 
	 * @param writer
	 *            the <CODE>PdfWriter</CODE>
	 * @param filePath
	 ...
	 *            it takes precedence over <CODE>filePath</CODE>
	 * @param compress
	 *            sets the compression on the data. Multimedia content will
	 ...
	 * @param fileParameter
	 *            the optional extra file parameters such as the creation or
	 *            modification date
	 * @throws IOException
	 *             on error
	 * @return the file specification
	 */
	public static PdfFileSpecification fileEmbedded(PdfWriter writer, String filePath, String fileDisplay, byte fileStore[], boolean compress, String mimeType,
	...
	/**
	 * Gets the indirect reference to this file specification. Multiple
	 * invocations will retrieve the same value.
	 * 
	 * @throws IOException
	 *             on error
	...
	/**
	 * Sets the file name (the key /F) string as an hex representation to
	 * support multi byte file names. The name must have the slash and backslash
	 * escaped according to the file specification rules
	 * 
	 * @param fileName
	...
	/**
	 * Adds the unicode file name (the key /UF). This entry was introduced in
	 * PDF 1.7. The filename must have the slash and backslash escaped according
	 * to the file specification rules.
	 * 
	 * @param filename
	 *            the filename
	 * @param unicode
	 *            if true, the filename is UTF-16BE encoded; otherwise
	...
	/**
	 * Sets a flag that indicates whether an external file referenced by the
	 * file specification is volatile. If the value is true, applications should
	 * never cache a copy of the file.
	 * 
	 * @param volatile_file
