...
import org.saipdf.text.factories.RomanNumberFactory;

/**
 * Page labels are used to identify each page visually on the screen or in
 * print.
 * 
...
public class PdfPageLabels {
	...
	/**
	 * Logical pages will have the form of uppercase letters (A to Z for the
	 * first 26 pages, AA to ZZ for the next 26, and so on)
	 */
	 ...
	 * @param text
	 *            the text to prefix the number. Can be <CODE>null</CODE> or
	 *            empty
	 * @param firstPage
	...
	/**
	 * Adds or replaces a page label. The first logical page has the default of
	 * 1.
	 * 
	 * @param page
	 *            the real page to start the numbering. First page is 1
	...
	/**
	 * Removes a page label. The first page label can not be removed, only
	 * changed.
	 * 
	 * @param page
	 ...
	 * 
	 * @param reader
	 *            a PdfReader object that has the page labels you want to
	 *            retrieve
	 ...
	 * {@link PdfPageLabelFormat} objects.
	 * 
	 * @param reader
	 *            a PdfReader object that has the page labels you want to
	 *            retrieve
	 * @return a PdfPageLabelEntry array, containing an entry for each format
	 *         change or <code>null</code> if no page labels are present
	 */
