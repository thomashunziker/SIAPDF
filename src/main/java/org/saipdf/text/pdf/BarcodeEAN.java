...
/**
 * Generates barcodes in several formats: EAN13, EAN8, UPCA, UPCE, supplemental
 * 2 and 5. The default parameters are:
 * 
 * <pre>
 * x = 0.8f;
...
public class BarcodeEAN extends Barcode {
	...
	private static final byte BARS[][] = { { 3, 2, 1, 1 }, // 0
			{ 2, 2, 2, 1 }, // 1
			{ 2, 1, 2, 2 }, // 2
			{ 1, 4, 1, 1 }, // 3
			{ 1, 1, 3, 2 }, // 4
	...
	private static final byte PARITY13[][] = { { ODD, ODD, ODD, ODD, ODD, ODD }, // 0
	...
	private static final byte PARITY2[][] = { { ODD, ODD }, // 0
			{ ODD, EVEN }, // 1
			{ EVEN, ODD }, // 2
			{ EVEN, EVEN } // 3
	};
	...
	/** Sequence of parities to be used with supplemental 2. */
	private static final byte PARITY5[][] = { { EVEN, EVEN, ODD, ODD, ODD }, // 0
	...
	private static final byte PARITYE[][] = { { EVEN, EVEN, EVEN, ODD, ODD, ODD }, // 0
	...
	/**
	 * Converts an UPCA code into an UPCE code. If the code can not be converted
	 * a <CODE>null</CODE> is returned.
	 * 
	 * @param text
	 *            the code to convert. It must have 12 numeric characters
	 * @return the 8 converted digits or <CODE>null</CODE> if the code could not
	 *         be converted
	 */
