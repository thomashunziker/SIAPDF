...
public abstract class Barcode {
	...
	/**
	 * The bar multiplier for wide bars or the distance between bars for Postnet
	 * and Planet.
	 */
	protected float n;
	...
	/**
	 * If positive, the text distance under the bars. If zero or negative, the
	 * text distance above the bars.
	 */
	...
	/**
	 * Show the start and stop character '*' in the text for the barcode 39 or
	 * 'ABCD' for codabar.
	 */
	 ...
	 * 
	 * @param font
	 *            the text font. Set to <CODE>null</CODE> to suppress any text
	 */
	 ...
	 * 
	 * @param cb
	 *            the <CODE>PdfContentByte</CODE> to create the template. It
	 *            serves no other use
	 * @param barColor
	 *            the color of the bars. It can be <CODE>null</CODE>
	 * @param textColor
	 ...
	 * 
	 * @param cb
	 *            the <CODE>PdfContentByte</CODE> to create the
	 *            <CODE>Image</CODE>. It serves no other use
	 * @param barColor
	 *            the color of the bars. It can be <CODE>null</CODE>
	 * @param textColor
	 *            the color of the text. It can be <CODE>null</CODE>
	...
	/**
	 * Sets the amount of ink spreading. This value will be subtracted to the
	 * width of each bar. The actual value will depend on the ink and the
	 * printing medium.
	 * 
	 * @param inkSpreading
	 *            the ink spreading
	...
	/**
	 * Sets the alternate text. If present, this text will be used instead of
	 * the text derived from the supplied code.
	 * 
	 * @param altText
	 *            the alternate text
	 */
