...
/**
 * Concatenates PDF documents including form fields. The rules for the form
 * field concatenation are the same as in Acrobat. All the documents are kept in
 * memory unlike PdfCopy.
 * 
