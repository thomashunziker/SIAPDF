 ...
 * original work of Paulo Soares. Hence it is perfectly justifiable to
 * distribute it under the MPL.
 * 
...
public class ArabicLigaturizer {
	...
	static int ligature(char newchar, charstruct oldchar) {
		...
		if (oldchar.vowel != 0) { /*
								 * if we already joined a vowel, we can't join a
								 * Hamza
								 */
			return 0;
		}
	...
	static void shape(char text[], StringBuffer string, int level) {
		/*
		 * string is assumed to be empty and big enough. text is the original
		 * text. This routine does the basic arabic reshaping. *len the number
	...
	private static final char chartable[][] = { { 0x0621, 0xFE80 }, /* HAMZA */
