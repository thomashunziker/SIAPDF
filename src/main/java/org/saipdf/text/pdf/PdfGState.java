...
public class PdfGState extends PdfDictionary {
	...
	/**
	 * Sets the flag whether to apply overprint for non stroking painting
	 * operations.
	 * 
	 * @param ov
	 */
	...
	/**
	 * Sets the flag whether to toggle knockout behavior for overprinted
	 * objects.
	 * 
	 * @param ov
	 *            - accepts 0 or 1
	...
	/**
	 * Sets the current stroking alpha constant, specifying the constant shape
	 * or constant opacity value to be used for stroking operations in the
	...
	/**
	 * Sets the current stroking alpha constant, specifying the constant shape
	 * or constant opacity value to be used for nonstroking operations in the
	 * transparent imaging model.
	 * 
	 * @param n
	 */
	...
	/**
	 * The alpha source flag specifying whether the current soft mask and alpha
	 * constant are to be interpreted as shape values (true) or opacity values
	 * (false).
	 * 
	 * @param v
	 */
	...
	/**
	 * Determines the behavior of overlapping glyphs within a text object in the
	 * transparent imaging model.
	 * 
	 * @param v
	 */
