...
public class TIFFConstants {
	...
	/*
	 * TIFFTAG_PIXAR_IMAGEFULLWIDTH and TIFFTAG_PIXAR_IMAGEFULLLENGTH are set
	 * when an image has been cropped out of a larger image. They reflect the
	 * size of the original uncropped image. The TIFFTAG_XPOSITION and
	 * TIFFTAG_YPOSITION can be used to determine the position of the smaller
	 * image in the larger one.
	 */
	...
	public static final int TIFFTAG_PIXAR_IMAGEFULLLENGTH = 33301; /*
																	 ...
																	 */
	/*
	 * Tags 33302-33306 are used to identify special image modes and data used
	 * by Pixar's texture formats.
	 */
