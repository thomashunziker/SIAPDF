 ...
 * <P>
 * Limitation: in this class only base 14 Type 1 fonts (courier, courier bold,
 * courier oblique, courier boldoblique, helvetica, helvetica bold, helvetica
 * oblique, helvetica boldoblique, symbol, times roman, times bold, times
 * italic, times bolditalic, zapfdingbats) and their standard encoding
 * (standard, MacRoman, (MacExpert,) WinAnsi) are supported.<BR>
 * This object is described in the 'Portable Document Format Reference Manual
 * version 1.3' section 7.7 (page 198-203).
 * 
 * @see PdfName
 * @see PdfDictionary
