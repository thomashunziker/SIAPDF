...
import org.saipdf.text.pdf.events.PdfPCellEventForwarder;
...
public class PdfPCell extends Rectangle {
	 ...
	 *            the <CODE>Image</CODE>
	 * @param fit
	 *            <CODE>true</CODE> to fit the image to the cell
	 */
	 ...
	 *            The <CODE>PdfPTable</CODE>
	 * @param style
	 *            The style to apply to the cell (you could use
	 *            getDefaultCell())
	 * @since 2.1.0
	 */
	 ...
	 * 
	 * @param cell
	 *            the <CODE>PdfPCell</CODE> to duplicate
	 */
	 ...
	 * 
	 * @param height
	 *            the hight of the part that has to be consumed
	 * @since 2.1.6
	 */
