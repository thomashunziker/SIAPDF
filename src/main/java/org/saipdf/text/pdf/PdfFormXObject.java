...
public class PdfFormXObject extends PdfStream {
	 ...
	 *            the compression level for the stream
	 * @since 2.1.3 (Replacing the existing constructor with param
	 *        compressionLevel)
	 */

	PdfFormXObject(PdfTemplate template, int compressionLevel) // throws
