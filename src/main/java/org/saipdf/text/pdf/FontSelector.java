 ...
 * correctly. The fonts are checked in order until the character is found.
 * <p>
 * The built in fonts "Symbol" and "ZapfDingbats", if used, have a special
 * encoding to allow the characters to be referred by Unicode.
 * 
