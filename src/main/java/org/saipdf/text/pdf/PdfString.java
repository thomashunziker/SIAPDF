...
/**
 * A <CODE>PdfString</CODE>-class is the PDF-equivalent of a JAVA-
 * <CODE>String</CODE>-object.
 * <P>
 * A string is a sequence of characters delimited by parenthesis. If a string is
 ...
 * indicate that the string continues on the following line. Within a string,
 * the backslash character is used as an escape to specify unbalanced
 * parenthesis, non-printing ASCII characters, and the backslash character
 * itself. Use of the \<I>ddd</I> escape sequence is the preferred way to
 * represent characters outside the printable ASCII character set.<BR>
...
public class PdfString extends PdfObject {
	...
	/**
	 * Returns the <CODE>String</CODE> value of this <CODE>PdfString</CODE>
	 * -object.
	 * 
