...
public interface PdfPTableEvent {
	...
	/**
	 * This method is called at the end of the table rendering. The text or
	 ...
	 * <p>
	 * The <CODE>widths</CODE> and <CODE>heights</CODE> have the coordinates of
	 * the cells.<br>
	 * The size of the <CODE>widths</CODE> array is the number of rows. Each
	 * sub-array in <CODE>widths</CODE> corresponds to the x column border
	 * positions where the first element is the x coordinate of the left table
	 * border and the last element is the x coordinate of the right table
	 * border. If colspan is not used all the sub-arrays in <CODE>widths</CODE>
	 * are the same.<br>
	 * For the <CODE>heights</CODE> the first element is the y coordinate of the
	 * top table border and the last element is the y coordinate of the bottom
	 * table border.
	 * 
	 * @param table
	 *            the <CODE>PdfPTable</CODE> in use
	 * @param widths
	 *            an array of arrays with the cells' x positions. It has the
	 *            length of the number of rows
	 * @param heights
	 *            an array with the cells' y positions. It has a length of the
	 *            number of rows + 1
	 * @param headerRows
