...
public class IndexEvents extends PdfPageEventHelper {
	 ...
	 * indexentry.
	 * 
	 * @see org.saipdf.text.pdf.PdfPageEventHelper#onGenericTag(org.saipdf.text.pdf.PdfWriter,
	 ...
	 * 
	 * @return Returns the sorted list with the entries and the collected page
	 *         numbers.
	 */
	 ...
	 * <p>
	 * In the first step, only in1, in2,in3 and tag are used. After the
	 * collections of the index entries, pagenumbers are used.
	 * </p>
	 */
	public class Entry {
