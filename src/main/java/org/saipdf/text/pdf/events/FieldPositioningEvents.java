 ...
 */
package org.saipdf.text.pdf.events;
...
public class FieldPositioningEvents extends PdfPageEventHelper implements PdfPCellEvent {
	...
	/**
	 * Creates a new event. This constructor will be used if you need to
	 * position fields with Chunk objects.
	 */
	public FieldPositioningEvents() {
	}

	/**
	 * Some extra padding that will be taken into account when defining the
	 * widget.
	 */
	...
	/**
	 * Creates a new event. This constructor will be used if you need to
	 * position fields with a Cell Event.
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfPageEvent#onGenericTag(org.saipdf.text.pdf.PdfWriter,
	 *      org.saipdf.text.Document, org.saipdf.text.Rectangle,
	 *      java.lang.String)
	 */
	public void onGenericTag(PdfWriter writer, Document document, Rectangle rect, String text) {
		...
		if (field == null) {
			TextField tf = new TextField(writer, new Rectangle(rect.getLeft(padding), rect.getBottom(padding), rect.getRight(padding), rect.getTop(padding)),
					text);
			tf.setFontSize(14);
			try {
	...
	/**
	 * @see org.saipdf.text.pdf.PdfPCellEvent#cellLayout(org.saipdf.text.pdf.PdfPCell,
	 *      org.saipdf.text.Rectangle, org.saipdf.text.pdf.PdfContentByte[])
	 */
	public void cellLayout(PdfPCell cell, Rectangle rect, PdfContentByte[] canvases) {
		if (cellField == null || (fieldWriter == null && parent == null))
			throw new IllegalArgumentException(
					MessageLocalization.getComposedMessage("you.have.used.the.wrong.constructor.for.this.fieldpositioningevents.class"));
