...
import org.saipdf.text.pdf.codec.Base64;
...
public class AcroFields {
	 ...
	 *             on error
	 * @throws org.saipdf.text.DocumentException
	 *             o error
	 */
			...
			try {
				...
				if (rotation != 0) {
					...
					case 270:
						...
						break;
					case 180:
						r = new Rectangle(pageSize.getRight() - r.getLeft(), pageSize.getTop() - r.getBottom(), pageSize.getRight() - r.getRight(),
