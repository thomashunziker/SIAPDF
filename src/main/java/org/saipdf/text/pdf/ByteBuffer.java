...
/**
 * Acts like a <CODE>StringBuffer</CODE> but works with <CODE>byte</CODE>
...
public class ByteBuffer extends OutputStream {
	...
	/**
	 * If <CODE>true</CODE> always output floating point numbers with 6 decimal
	 * digits. If <CODE>false</CODE> uses the faster, although less precise,
	 * representation.
	 */
	 ...
	 * Sets the cache size.
	 * <P>
	 * This can only be used to increment the size. If the size that is passed
	 * through is smaller than the current size, nothing happens.
	 * 
	 * @param size
	...
	/**
	 * Converts an double (multiplied by 100 and cast to an int) into an array
	 * of bytes.
	 * 
	 * @param i
	 *            the int
	...
	/**
	 * Appends the subarray of the <CODE>byte</CODE> array. The buffer will grow
	 * by <CODE>len</CODE> bytes.
	 * 
	 * @param b
	 ...
	 * 
	 * @param buf
	 *            the <CODE>ByteBuffer</CODE> to be appended
	 * @return a reference to this <CODE>ByteBuffer</CODE> object
	 */
	 ...
	 * 
	 * @param i
	 *            the <CODE>int</CODE> to be appended
	 * @return a reference to this <CODE>ByteBuffer</CODE> object
	 */
	...
	/**
	 * Appends a string representation of a <CODE>float</CODE> according to the
	 * Pdf conventions.
	 * 
	 * @param i
	 *            the <CODE>float</CODE> to be appended
	 * @return a reference to this <CODE>ByteBuffer</CODE> object
	 */
	...
	/**
	 * Appends a string representation of a <CODE>double</CODE> according to the
	 * Pdf conventions.
	 * 
	 * @param d
	 *            the <CODE>double</CODE> to be appended
	 * @return a reference to this <CODE>ByteBuffer</CODE> object
	 */
	 ...
	 *            a ByteBuffer
	 * @return the <CODE>String</CODE> representation of the <CODE>double</CODE>
	 *         if <CODE>buf</CODE> is <CODE>null</CODE>. If <CODE>buf</CODE> is
	 *         <B>not</B> <CODE>null</CODE>, then the double is appended
	 *         directly to the buffer and this methods returns <CODE>null</CODE>
	 *         .
	 */
	 ...
	 *         valid bytes in this byte buffer.
	 */
	public int size() {
		return count;
	}
