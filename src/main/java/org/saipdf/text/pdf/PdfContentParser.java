...
public class PdfContentParser {
	...
	/**
	 * Parses a single command from the content. Each command is output as an
	 * array of arguments having the command itself as the last element. The
	 * returned array will be empty if the end of content was reached.
	 * 
	 * @param ls
	 *            an <CODE>ArrayList</CODE> to use. It will be cleared before
	 *            using. If it's <CODE>null</CODE> will create a new
	 *            <CODE>ArrayList</CODE>
	 ...
	 * 
	 * @return <CODE>true</CODE> if a token was read, <CODE>false</CODE> if the
