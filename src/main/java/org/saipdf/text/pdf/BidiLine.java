...
import org.saipdf.text.Chunk;
import org.saipdf.text.Utilities;
...
public class BidiLine {
	...
	// protected ArabicShaping arabic = new
	// ArabicShaping(ArabicShaping.LETTERS_SHAPE |
	// ArabicShaping.LENGTH_GROW_SHRINK | ArabicShaping.TEXT_DIRECTION_LOGICAL);
	...
	public PdfLine processLine(float leftX, float width, int alignment, int runDirection, int arabicOptions) {
		...
		if (newCurrentChar == currentChar - 1) { // middle of word
			...
			if (he != null) {
				...
				if (word != null) {
					...
					String pre = he.getHyphenatedWordPre(new String(text, word[0], word[1] - word[0]), lastValidChunk.font().getFont(), lastValidChunk.font()
							.size(), testWidth);
					String post = he.getHyphenatedWordPost();
					if (pre.length() > 0) {
						PdfChunk extra = new PdfChunk(pre, lastValidChunk);
						currentChar = word[1] - post.length();
						return new PdfLine(0, originalWidth, testWidth - lastValidChunk.font().width(pre), alignment, false, createArrayOfPdfChunks(
								oldCurrentChar, word[0] - 1, extra), isRTL);
					}
				}
			}
		}
		if (lastSplit == -1 || lastSplit >= newCurrentChar) {
			...
			return new PdfLine(0, originalWidth, width + getWidth(newCurrentChar + 1, currentChar - 1), alignment, false, createArrayOfPdfChunks(
					oldCurrentChar, newCurrentChar), isRTL);
		}
		// standard split
		...
		return new PdfLine(0, originalWidth, originalWidth - getWidth(oldCurrentChar, newCurrentChar), alignment, false, createArrayOfPdfChunks(oldCurrentChar,
				newCurrentChar), isRTL);
	}
	...
	static {
		...
		mirrorChars.put(0x00AB, 0x00BB); // LEFT-POINTING DOUBLE ANGLE QUOTATION
											// MARK
		mirrorChars.put(0x00BB, 0x00AB); // RIGHT-POINTING DOUBLE ANGLE
											// QUOTATION MARK
		mirrorChars.put(0x2039, 0x203A); // SINGLE LEFT-POINTING ANGLE QUOTATION
											// MARK
		mirrorChars.put(0x203A, 0x2039); // SINGLE RIGHT-POINTING ANGLE
											// QUOTATION MARK
		...
		mirrorChars.put(0x2252, 0x2253); // APPROXIMATELY EQUAL TO OR THE IMAGE
											// OF
		...
		mirrorChars.put(0x2268, 0x2269); // [BEST FIT] LESS-THAN BUT NOT EQUAL
											// TO
		mirrorChars.put(0x2269, 0x2268); // [BEST FIT] GREATER-THAN BUT NOT
											// EQUAL TO
		...
		mirrorChars.put(0x2270, 0x2271); // [BEST FIT] NEITHER LESS-THAN NOR
											// EQUAL TO
		mirrorChars.put(0x2271, 0x2270); // [BEST FIT] NEITHER GREATER-THAN NOR
											// EQUAL TO
		mirrorChars.put(0x2272, 0x2273); // [BEST FIT] LESS-THAN OR EQUIVALENT
											// TO
		mirrorChars.put(0x2273, 0x2272); // [BEST FIT] GREATER-THAN OR
											// EQUIVALENT TO
		mirrorChars.put(0x2274, 0x2275); // [BEST FIT] NEITHER LESS-THAN NOR
											// EQUIVALENT TO
		mirrorChars.put(0x2275, 0x2274); // [BEST FIT] NEITHER GREATER-THAN NOR
											// EQUIVALENT TO
		...
		mirrorChars.put(0x2288, 0x2289); // [BEST FIT] NEITHER A SUBSET OF NOR
											// EQUAL TO
		mirrorChars.put(0x2289, 0x2288); // [BEST FIT] NEITHER A SUPERSET OF NOR
											// EQUAL TO
		mirrorChars.put(0x228A, 0x228B); // [BEST FIT] SUBSET OF WITH NOT EQUAL
											// TO
		mirrorChars.put(0x228B, 0x228A); // [BEST FIT] SUPERSET OF WITH NOT
											// EQUAL TO
		...
		mirrorChars.put(0x22AB, 0x2AE5); // DOUBLE VERTICAL BAR DOUBLE RIGHT
											// TURNSTILE
		...
		mirrorChars.put(0x22B5, 0x22B4); // CONTAINS AS NORMAL SUBGROUP OR EQUAL
											// TO
		mirrorChars.put(0x22B6, 0x22B7); // ORIGINAL OF
		mirrorChars.put(0x22B7, 0x22B6); // IMAGE OF
		mirrorChars.put(0x22C9, 0x22CA); // LEFT NORMAL FACTOR SEMIDIRECT
											// PRODUCT
		mirrorChars.put(0x22CA, 0x22C9); // RIGHT NORMAL FACTOR SEMIDIRECT
											// PRODUCT
		...
		mirrorChars.put(0x22E2, 0x22E3); // [BEST FIT] NOT SQUARE IMAGE OF OR
											// EQUAL TO
		mirrorChars.put(0x22E3, 0x22E2); // [BEST FIT] NOT SQUARE ORIGINAL OF OR
											// EQUAL TO
		mirrorChars.put(0x22E4, 0x22E5); // [BEST FIT] SQUARE IMAGE OF OR NOT
											// EQUAL TO
		mirrorChars.put(0x22E5, 0x22E4); // [BEST FIT] SQUARE ORIGINAL OF OR NOT
											// EQUAL TO
		mirrorChars.put(0x22E6, 0x22E7); // [BEST FIT] LESS-THAN BUT NOT
											// EQUIVALENT TO
		mirrorChars.put(0x22E7, 0x22E6); // [BEST FIT] GREATER-THAN BUT NOT
											// EQUIVALENT TO
		mirrorChars.put(0x22E8, 0x22E9); // [BEST FIT] PRECEDES BUT NOT
											// EQUIVALENT TO
		mirrorChars.put(0x22E9, 0x22E8); // [BEST FIT] SUCCEEDS BUT NOT
											// EQUIVALENT TO
		mirrorChars.put(0x22EA, 0x22EB); // [BEST FIT] NOT NORMAL SUBGROUP OF
		mirrorChars.put(0x22EB, 0x22EA); // [BEST FIT] DOES NOT CONTAIN AS
											// NORMAL SUBGROUP
		mirrorChars.put(0x22EC, 0x22ED); // [BEST FIT] NOT NORMAL SUBGROUP OF OR
											// EQUAL TO
		mirrorChars.put(0x22ED, 0x22EC); // [BEST FIT] DOES NOT CONTAIN AS
											// NORMAL SUBGROUP OR EQUAL
		mirrorChars.put(0x22F0, 0x22F1); // UP RIGHT DIAGONAL ELLIPSIS
		mirrorChars.put(0x22F1, 0x22F0); // DOWN RIGHT DIAGONAL ELLIPSIS
		mirrorChars.put(0x22F2, 0x22FA); // ELEMENT OF WITH LONG HORIZONTAL
											// STROKE
		mirrorChars.put(0x22F3, 0x22FB); // ELEMENT OF WITH VERTICAL BAR AT END
											// OF HORIZONTAL STROKE
		mirrorChars.put(0x22F4, 0x22FC); // SMALL ELEMENT OF WITH VERTICAL BAR
		...
		mirrorChars.put(0x22FB, 0x22F3); // CONTAINS WITH VERTICAL BAR AT END OF
											// HORIZONTAL STROKE
		mirrorChars.put(0x22FC, 0x22F4); // SMALL CONTAINS WITH VERTICAL BAR AT
		...
		mirrorChars.put(0x276A, 0x276B); // MEDIUM FLATTENED LEFT PARENTHESIS
											// ORNAMENT
		mirrorChars.put(0x276B, 0x276A); // MEDIUM FLATTENED RIGHT PARENTHESIS
											// ORNAMENT
		mirrorChars.put(0x276C, 0x276D); // MEDIUM LEFT-POINTING ANGLE BRACKET
											// ORNAMENT
		mirrorChars.put(0x276D, 0x276C); // MEDIUM RIGHT-POINTING ANGLE BRACKET
											// ORNAMENT
		mirrorChars.put(0x276E, 0x276F); // HEAVY LEFT-POINTING ANGLE QUOTATION
											// MARK ORNAMENT
		mirrorChars.put(0x276F, 0x276E); // HEAVY RIGHT-POINTING ANGLE QUOTATION
											// MARK ORNAMENT
		mirrorChars.put(0x2770, 0x2771); // HEAVY LEFT-POINTING ANGLE BRACKET
											// ORNAMENT
		mirrorChars.put(0x2771, 0x2770); // HEAVY RIGHT-POINTING ANGLE BRACKET
											// ORNAMENT
		...
		mirrorChars.put(0x27E2, 0x27E3); // WHITE CONCAVE-SIDED DIAMOND WITH
											// LEFTWARDS TICK
		mirrorChars.put(0x27E3, 0x27E2); // WHITE CONCAVE-SIDED DIAMOND WITH
											// RIGHTWARDS TICK
		...
		mirrorChars.put(0x27E6, 0x27E7); // MATHEMATICAL LEFT WHITE SQUARE
											// BRACKET
		mirrorChars.put(0x27E7, 0x27E6); // MATHEMATICAL RIGHT WHITE SQUARE
											// BRACKET
		...
		mirrorChars.put(0x27EA, 0x27EB); // MATHEMATICAL LEFT DOUBLE ANGLE
											// BRACKET
		mirrorChars.put(0x27EB, 0x27EA); // MATHEMATICAL RIGHT DOUBLE ANGLE
											// BRACKET
		...
		mirrorChars.put(0x298D, 0x2990); // LEFT SQUARE BRACKET WITH TICK IN TOP
											// CORNER
		mirrorChars.put(0x298E, 0x298F); // RIGHT SQUARE BRACKET WITH TICK IN
											// BOTTOM CORNER
		mirrorChars.put(0x298F, 0x298E); // LEFT SQUARE BRACKET WITH TICK IN
											// BOTTOM CORNER
		mirrorChars.put(0x2990, 0x298D); // RIGHT SQUARE BRACKET WITH TICK IN
											// TOP CORNER
		...
		mirrorChars.put(0x2A34, 0x2A35); // MULTIPLICATION SIGN IN LEFT HALF
											// CIRCLE
		mirrorChars.put(0x2A35, 0x2A34); // MULTIPLICATION SIGN IN RIGHT HALF
											// CIRCLE
		...
		mirrorChars.put(0x2A7F, 0x2A80); // LESS-THAN OR SLANTED EQUAL TO WITH
											// DOT INSIDE
		mirrorChars.put(0x2A80, 0x2A7F); // GREATER-THAN OR SLANTED EQUAL TO
											// WITH DOT INSIDE
		mirrorChars.put(0x2A81, 0x2A82); // LESS-THAN OR SLANTED EQUAL TO WITH
											// DOT ABOVE
		mirrorChars.put(0x2A82, 0x2A81); // GREATER-THAN OR SLANTED EQUAL TO
											// WITH DOT ABOVE
		mirrorChars.put(0x2A83, 0x2A84); // LESS-THAN OR SLANTED EQUAL TO WITH
											// DOT ABOVE RIGHT
		mirrorChars.put(0x2A84, 0x2A83); // GREATER-THAN OR SLANTED EQUAL TO
											// WITH DOT ABOVE LEFT
		mirrorChars.put(0x2A8B, 0x2A8C); // LESS-THAN ABOVE DOUBLE-LINE EQUAL
											// ABOVE GREATER-THAN
		mirrorChars.put(0x2A8C, 0x2A8B); // GREATER-THAN ABOVE DOUBLE-LINE EQUAL
											// ABOVE LESS-THAN
		mirrorChars.put(0x2A91, 0x2A92); // LESS-THAN ABOVE GREATER-THAN ABOVE
											// DOUBLE-LINE EQUAL
		mirrorChars.put(0x2A92, 0x2A91); // GREATER-THAN ABOVE LESS-THAN ABOVE
											// DOUBLE-LINE EQUAL
		mirrorChars.put(0x2A93, 0x2A94); // LESS-THAN ABOVE SLANTED EQUAL ABOVE
											// GREATER-THAN ABOVE SLANTED EQUAL
		mirrorChars.put(0x2A94, 0x2A93); // GREATER-THAN ABOVE SLANTED EQUAL
											// ABOVE LESS-THAN ABOVE SLANTED
											// EQUAL
		...
		mirrorChars.put(0x2A97, 0x2A98); // SLANTED EQUAL TO OR LESS-THAN WITH
											// DOT INSIDE
		mirrorChars.put(0x2A98, 0x2A97); // SLANTED EQUAL TO OR GREATER-THAN
											// WITH DOT INSIDE
		...
		mirrorChars.put(0x2A9B, 0x2A9C); // DOUBLE-LINE SLANTED EQUAL TO OR
											// LESS-THAN
		mirrorChars.put(0x2A9C, 0x2A9B); // DOUBLE-LINE SLANTED EQUAL TO OR
											// GREATER-THAN
		...
		mirrorChars.put(0x2AA8, 0x2AA9); // LESS-THAN CLOSED BY CURVE ABOVE
											// SLANTED EQUAL
		mirrorChars.put(0x2AA9, 0x2AA8); // GREATER-THAN CLOSED BY CURVE ABOVE
											// SLANTED EQUAL
		...
		mirrorChars.put(0x2AAF, 0x2AB0); // PRECEDES ABOVE SINGLE-LINE EQUALS
											// SIGN
		mirrorChars.put(0x2AB0, 0x2AAF); // SUCCEEDS ABOVE SINGLE-LINE EQUALS
											// SIGN
		...
		mirrorChars.put(0x2AC1, 0x2AC2); // SUBSET WITH MULTIPLICATION SIGN
											// BELOW
		mirrorChars.put(0x2AC2, 0x2AC1); // SUPERSET WITH MULTIPLICATION SIGN
											// BELOW
		mirrorChars.put(0x2AC3, 0x2AC4); // SUBSET OF OR EQUAL TO WITH DOT ABOVE
		mirrorChars.put(0x2AC4, 0x2AC3); // SUPERSET OF OR EQUAL TO WITH DOT
											// ABOVE
		...
		mirrorChars.put(0x2AE5, 0x22AB); // DOUBLE VERTICAL BAR DOUBLE LEFT
											// TURNSTILE
		...
		mirrorChars.put(0x2AF9, 0x2AFA); // DOUBLE-LINE SLANTED LESS-THAN OR
											// EQUAL TO
		mirrorChars.put(0x2AFA, 0x2AF9); // DOUBLE-LINE SLANTED GREATER-THAN OR
											// EQUAL TO
		...
		mirrorChars.put(0x300F, 0x300E); // [BEST FIT] RIGHT WHITE CORNER
											// BRACKET
		...
		mirrorChars.put(0xFF62, 0xFF63); // [BEST FIT] HALFWIDTH LEFT CORNER
											// BRACKET
		mirrorChars.put(0xFF63, 0xFF62); // [BEST FIT] HALFWIDTH RIGHT CORNER
											// BRACKET
	}
}