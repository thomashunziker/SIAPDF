...
/**
 * This class takes 2 barcodes, an EAN/UPC and a supplemental and creates a
 * single barcode with both combined in the expected layout. The UPC/EAN should
 * have a positive text baseline and the supplemental a negative one (in the
