...
/**
 * The default class that is used to determine whether or not a character is a
 * split character. You can subclass this class to define your own split
 * characters.
 * 
 * @since 2.1.2
 */
public class DefaultSplitCharacter implements SplitCharacter {
	...
	public boolean isSplitCharacter(int start, int current, int end, char[] cc, PdfChunk[] ck) {
		...
		if (c < 0x2002)
			return false;
		return ((c >= 0x2002 && c <= 0x200b) || (c >= 0x2e80 && c < 0xd7a0) || (c >= 0xf900 && c < 0xfb00) || (c >= 0xfe30 && c < 0xfe50) || (c >= 0xff61 && c < 0xffa0));
	}
