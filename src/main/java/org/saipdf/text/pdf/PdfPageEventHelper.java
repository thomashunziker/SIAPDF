...
/**
 * Helps the use of <CODE>PdfPageEvent</CODE> by implementing all the interface
 * methods. A class can extend <CODE>PdfPageEventHelper</CODE> and only
...
public class PdfPageEventHelper implements PdfPageEvent {
	 ...
	 *            the document
	 * @param rect
	 *            the <CODE>Rectangle</CODE> containing the <CODE>Chunk</CODE>
	 * @param text
	 *            the text of the tag
	 */
