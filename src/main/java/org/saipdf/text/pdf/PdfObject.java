...
public abstract class PdfObject {
	...
	/**
	 * An empty string used for the <CODE>PdfNull</CODE>-object and for an empty
	 * <CODE>PdfString</CODE>-object.
	 */
	public static final String NOTHING = "";

	/**
	 * This is the default encoding to be used for converting Strings into bytes
	 * and vice versa. The default encoding is PdfDocEncoding.
	 */
	...
	/**
	 * Constructs a <CODE>PdfObject</CODE> of a certain <VAR>type</VAR> without
	 * any <VAR>content</VAR>.
	 * 
	 * @param type
	 *            type of the new <CODE>PdfObject</CODE>
	 */
	...
	/**
	 * Constructs a <CODE>PdfObject</CODE> of a certain <VAR>type</VAR> with a
	 * certain <VAR>content</VAR>.
	 * 
	 * @param type
	 *            type of the new <CODE>PdfObject</CODE>
	 * @param content
	 *            content of the new <CODE>PdfObject</CODE> as a
	 *            <CODE>String</CODE>.
	 */
	 ...
	 *            type of the new <CODE>PdfObject</CODE>
	 * @param bytes
	 *            content of the new <CODE>PdfObject</CODE> as an array of
	 *            <CODE>byte</CODE>.
	 */
	...
	/**
	 * Writes the PDF representation of this <CODE>PdfObject</CODE> as an array
	 * of <CODE>byte</CODE>s to the writer.
	 * 
	 * @param writer
	 ...
	 * 
	 * PdfObjects of type STREAM OR INDIRECT can not be contained in an object
	 * stream.
	 * 
	...
	/**
	 * Returns the length of the PDF representation of the
	 * <CODE>PdfObject</CODE>.
	 * <P>
	 * In some cases, namely for <CODE>PdfString</CODE> and
	 * <CODE>PdfStream</CODE>, this method differs from the method
	 * <CODE>length</CODE> because <CODE>length</CODE> returns the length of the
	 * actual content of the <CODE>PdfObject</CODE>.
	 * </P>
	 * <P>
	 * Remark: the actual content of an object is in most cases identical to its
	 * representation. The following statement is always true: length() &gt;=
	 * pdfLength().
	 * </P>
	 * 
	 * @return a length
	 ...
	 * In some cases, namely for <CODE>PdfString</CODE> and
	 * <CODE>PdfStream</CODE>, this method differs from the method
	 * <CODE>pdfLength</CODE> because <CODE>pdfLength</CODE> returns the length
	 * of the PDF representation of the object, not of the actual content as
	 * does the method <CODE>length</CODE>.
	 * </P>
	 * <P>
	 * Remark: the actual content of an object is in some cases identical to its
	 * representation. The following statement is always true: length() &gt;=
	 * pdfLength().
	 * </P>
	 * 
	 ...
	 * 
	 * @param content
	 *            the new content of this <CODE>PdfObject</CODE>
	 */
	 ...
	 * 
	 * May be either of: - <VAR>NULL</VAR>: A <CODE>PdfNull</CODE> -
	 * <VAR>BOOLEAN</VAR>: A <CODE>PdfBoolean</CODE> - <VAR>NUMBER</VAR>: A
	 * <CODE>PdfNumber</CODE> - <VAR>STRING</VAR>: A <CODE>PdfString</CODE> -
	 * <VAR>NAME</VAR>: A <CODE>PdfName</CODE> - <VAR>ARRAY</VAR>: A
	 * <CODE>PdfArray</CODE> - <VAR>DICTIONARY</VAR>: A
	 * <CODE>PdfDictionary</CODE> - <VAR>STREAM</VAR>: A <CODE>PdfStream</CODE>
	 ...
	 * 
	 * @return <CODE>true</CODE> if this is an indirect object, otherwise
	 *         <CODE>false</CODE>
	 */
	 ...
	 * 
	 * @param indRef
	 *            New value as a <CODE>PdfIndirectReference</CODE>
	 */
