 ...
 * <P>
 * A dictionary is an associative table containing pairs of objects. The first
 * element of each pair is called the <I>key</I> and the second element is
 * called the <I>value</I>. Unlike dictionaries in the PostScript language, a
 * key must be a <CODE>PdfName</CODE>. A value can be any kind of
 * <CODE>PdfObject</CODE>, including a dictionary. A dictionary is generally
 * used to collect and tie together the attributes of a complex object, with
 * each key-value pair specifying the name and value of an attribute.<BR>
...
public class PdfDictionary extends PdfObject {
	...
	/**
	 * This is the hashmap that contains all the values and keys of the
	 * dictionary
	 */
	 ...
	 * 
	 * The string doesn't contain any of the content of this dictionary. Rather
	 * the string "dictionary" is returned, possibly followed by the type of
	 * this <CODE>PdfDictionary</CODE>, if set.
	 * 
	 * @return the string representation of this <CODE>PdfDictionary</CODE>
	 * @see org.saipdf.text.pdf.PdfObject#toString()
	 */
	...
	/**
	 * Associates the specified <CODE>PdfObject</CODE> as value to the specified
	 * <CODE>PdfName</CODE> as key in this map.
	 * 
	 ...
	 *            a <CODE>PdfName</CODE>
	 * @param value
	 *            the <CODE>PdfObject</CODE> to be associated to the
	 *            <VAR>key</VAR>
	 */
	 ...
	 * 
	 * @param dic
	 *            The <CODE>PdfDictionary</CODE> with the mappings to be copied
	 *            over
	 */
	 ...
	 * and resolved to a direct object. If it is a <CODE>PdfDictionary</CODE>,
	 * it is cast down and returned as such. Otherwise <CODE>null</CODE> is
	 * returned.
	 * 
	 * @param key
	 *            A <CODE>PdfName</CODE>
	 * @return the associated <CODE>PdfDictionary</CODE> object, or
	 *         <CODE>null</CODE>
	 */
	 ...
	 * 
	 * The object associated with the <CODE>PdfName</CODE> given is retrieved
	 * and resolved to a direct object. If it is a <CODE>PdfArray</CODE>, it is
	 ...
	 * 
	 * The object associated with the <CODE>PdfName</CODE> given is retrieved
	 * and resolved to a direct object. If it is a <CODE>PdfStream</CODE>, it is
	 * cast down and returned as such. Otherwise <CODE>null</CODE> is returned.
	 * 
	 * @param key
	 *            A <CODE>PdfName</CODE>
	 * @return the associated <CODE>PdfStream</CODE> object, or
	 *         <CODE>null</CODE>
	 */
	 ...
	 * 
	 * The object associated with the <CODE>PdfName</CODE> given is retrieved
	 * and resolved to a direct object. If it is a <CODE>PdfString</CODE>, it is
	 * cast down and returned as such. Otherwise <CODE>null</CODE> is returned.
	 * 
	 * @param key
	 *            A <CODE>PdfName</CODE>
	 * @return the associated <CODE>PdfString</CODE> object, or
	 *         <CODE>null</CODE>
	 */
	 ...
	 * 
	 * The object associated with the <CODE>PdfName</CODE> given is retrieved
	 * and resolved to a direct object. If it is a <CODE>PdfNumber</CODE>, it is
	 * cast down and returned as such. Otherwise <CODE>null</CODE> is returned.
	 * 
	 * @param key
	 *            A <CODE>PdfName</CODE>
	 * @return the associated <CODE>PdfNumber</CODE> object, or
	 *         <CODE>null</CODE>
	 */
	 ...
	 * 
	 * The object associated with the <CODE>PdfName</CODE> given is retrieved
	 * and resolved to a direct object. If it is a <CODE>PdfName</CODE>, it is
	 * cast down and returned as such. Otherwise <CODE>null</CODE> is returned.
	 * 
	 * @param key
	 *            A <CODE>PdfName</CODE>
	 ...
	 * 
	 * The object associated with the <CODE>PdfName</CODE> given is retrieved
	 * and resolved to a direct object. If it is a <CODE>PdfBoolean</CODE>, it
	 * is cast down and returned as such. Otherwise <CODE>null</CODE> is
	 * returned.
	 * 
	 * @param key
	 *            A <CODE>PdfName</CODE>
	 * @return the associated <CODE>PdfBoolean</CODE> object, or
	 *         <CODE>null</CODE>
	 */
	 ...
	 * 
	 * The object associated with the <CODE>PdfName</CODE> given is retrieved If
	 * it is a <CODE>PdfIndirectReference</CODE>, it is cast down and returned
	 * as such. Otherwise <CODE>null</CODE> is returned.
	 * 
	 * @param key
	 *            A <CODE>PdfName</CODE>
	 * @return the associated <CODE>PdfIndirectReference</CODE> object, or
	 *         <CODE>null</CODE>
	 */
