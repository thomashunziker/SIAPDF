...
public class CFFFont {
	...
	static final String operatorNames[] = { "version", "Notice", "FullName", "FamilyName", "Weight", "FontBBox", "BlueValues", "OtherBlues", "FamilyBlues",
			"FamilyOtherBlues", "StdHW", "StdVW", "UNKNOWN_12", "UniqueID", "XUID", "charset", "Encoding", "CharStrings", "Private", "Subrs", "defaultWidthX",
			"nominalWidthX", "UNKNOWN_22", "UNKNOWN_23", "UNKNOWN_24", "UNKNOWN_25", "UNKNOWN_26", "UNKNOWN_27", "UNKNOWN_28", "UNKNOWN_29", "UNKNOWN_30",
			"UNKNOWN_31", "Copyright", "isFixedPitch", "ItalicAngle", "UnderlinePosition", "UnderlineThickness", "PaintType", "CharstringType", "FontMatrix",
			"StrokeWidth", "BlueScale", "BlueShift", "BlueFuzz", "StemSnapH", "StemSnapV", "ForceBold", "UNKNOWN_12_15", "UNKNOWN_12_16", "LanguageGroup",
			"ExpansionFactor", "initialRandomSeed", "SyntheticBase", "PostScript", "BaseFontName", "BaseFontBlend", "UNKNOWN_12_24", "UNKNOWN_12_25",
			"UNKNOWN_12_26", "UNKNOWN_12_27", "UNKNOWN_12_28", "UNKNOWN_12_29", "ROS", "CIDFontVersion", "CIDFontRevision", "CIDFontType", "CIDCount",
			"UIDBase", "FDArray", "FDSelect", "FontName" };

	static final String standardStrings[] = {
			// Automatically generated from Appendix A of the CFF specification;
			// do
			...
			"ordmasculine", "ae", "dotlessi", "lslash", "oslash", "oe", "germandbls", "onesuperior", "logicalnot", "mu", "trademark", "Eth", "onehalf",
			...
			"Scaron", "Uacute", "Ucircumflex", "Udieresis", "Ugrave", "Yacute", "Ydieresis", "Zcaron", "aacute", "acircumflex", "adieresis", "agrave", "aring",
			"atilde", "ccedilla", "eacute", "ecircumflex", "edieresis", "egrave", "iacute", "icircumflex", "idieresis", "igrave", "ntilde", "oacute",
			"ocircumflex", "odieresis", "ograve", "otilde", "scaron", "uacute", "ucircumflex", "udieresis", "ugrave", "yacute", "ydieresis", "zcaron",
			"exclamsmall", "Hungarumlautsmall", "dollaroldstyle", "dollarsuperior", "ampersandsmall", "Acutesmall", "parenleftsuperior", "parenrightsuperior",
			"twodotenleader", "onedotenleader", "zerooldstyle", "oneoldstyle", "twooldstyle", "threeoldstyle", "fouroldstyle", "fiveoldstyle", "sixoldstyle",
			"sevenoldstyle", "eightoldstyle", "nineoldstyle", "commasuperior", "threequartersemdash", "periodsuperior", "questionsmall", "asuperior",
			"bsuperior", "centsuperior", "dsuperior", "esuperior", "isuperior", "lsuperior", "msuperior", "nsuperior", "osuperior", "rsuperior", "ssuperior",
			"tsuperior", "ff", "ffi", "ffl", "parenleftinferior", "parenrightinferior", "Circumflexsmall", "hyphensuperior", "Gravesmall", "Asmall", "Bsmall",
			"Csmall", "Dsmall", "Esmall", "Fsmall", "Gsmall", "Hsmall", "Ismall", "Jsmall", "Ksmall", "Lsmall", "Msmall", "Nsmall", "Osmall", "Psmall",
			"Qsmall", "Rsmall", "Ssmall", "Tsmall", "Usmall", "Vsmall", "Wsmall", "Xsmall", "Ysmall", "Zsmall", "colonmonetary", "onefitted", "rupiah",
			"Tildesmall", "exclamdownsmall", "centoldstyle", "Lslashsmall", "Scaronsmall", "Zcaronsmall", "Dieresissmall", "Brevesmall", "Caronsmall",
			"Dotaccentsmall", "Macronsmall", "figuredash", "hypheninferior", "Ogoneksmall", "Ringsmall", "Cedillasmall", "questiondownsmall", "oneeighth",
			"threeeighths", "fiveeighths", "seveneighths", "onethird", "twothirds", "zerosuperior", "foursuperior", "fivesuperior", "sixsuperior",
			"sevensuperior", "eightsuperior", "ninesuperior", "zeroinferior", "oneinferior", "twoinferior", "threeinferior", "fourinferior", "fiveinferior",
			"sixinferior", "seveninferior", "eightinferior", "nineinferior", "centinferior", "dollarinferior", "periodinferior", "commainferior",
			"Agravesmall", "Aacutesmall", "Acircumflexsmall", "Atildesmall", "Adieresissmall", "Aringsmall", "AEsmall", "Ccedillasmall", "Egravesmall",
			"Eacutesmall", "Ecircumflexsmall", "Edieresissmall", "Igravesmall", "Iacutesmall", "Icircumflexsmall", "Idieresissmall", "Ethsmall", "Ntildesmall",
			"Ogravesmall", "Oacutesmall", "Ocircumflexsmall", "Otildesmall", "Odieresissmall", "OEsmall", "Oslashsmall", "Ugravesmall", "Uacutesmall",
			"Ucircumflexsmall", "Udieresissmall", "Yacutesmall", "Thornsmall", "Ydieresissmall", "001.000", "001.001", "001.002", "001.003", "Black", "Bold",
	...
	protected static abstract class OffsetItem extends Item {
		...
		/**
		 * set the value of an offset item that was initially unknown. It will
		 * be fixed up latex by a call to xref on some marker.
		 */
	...
	/**
	 * An index-offset item for the list. The size denotes the required size in
	 * the CFF. A positive value means that we need a specific size in bytes
	 * (for offset arrays) and a negative value means that this is a dict item
	 * that uses a variable-size representation.
	 */
	static protected final class IndexOffsetItem extends OffsetItem {
		...
		public void emit(byte[] buffer) {
			...
			/*
			 * int mask = 0xff; for (int i=size-1; i>=0; i--) {
			 * buffer[myOffset+i] = (byte) (value & mask); mask <<= 8; }
			 */
		}
	}
	...
	/**
	 * an unknown offset in a dictionary for the list. We will fix up the offset
	 * later; for now, assume it's large.
	 */
	...
	/**
	 * A dictionary number on the list. This implementation is inefficient: it
	 * doesn't use the variable-length representation.
	 */
	...
	/**
	 * An offset-marker item for the list. It is used to mark an offset and to
	 * set the offset list item.
	 */
	...
	/**
	 * get a single CID font. The PDF architecture (1.4) supports 16-bit strings
	 * only with CID CFF fonts, not in Type-1 CFF fonts, so we convert the font
	 * to CID if it is in the Type-1 format. Two other tasks that we need to do
	 * are to select only a single font from the CFF package (this again is a
	 * PDF restriction) and to subset the CharStrings glyph description.
	 */
	...
	// throws java.io.FileNotFoundException
	{
		...
		/*
		 * int maxTopdictLen = (topdictOffsets[j+1]-topdictOffsets[j]) + 9*2 //
		 * at most 9 new keys + 8*5 // 8 new integer arguments + 3*2;// 3 new
		 * SID arguments
		 */
		...
		if (fonts[j].isCID) {
			...
			for (int i = 0; i < stringOffsets.length; i++)
				l.addLast(new IndexOffsetItem(stringsIndexOffSize, stringOffsets[i] - stringsBaseOffset));
		...
		if (fonts[j].isCID) {
			...
			l.addLast(new UInt16Item((char) 1)); // first glyph in range (ignore
													// .notdef)
			...
			// l.addLast(new
			// DictNumberItem((standardStrings.length+(stringOffsets.length-1)+2)));
			// l.addLast(new UInt8Item((char)12));
	...
	public CFFFont(RandomAccessFileOrArray inputbuffer) {
		...
		/*
		 * names = new String[nfonts]; privateOffset = new int[nfonts];
		 * charsetOffset = new int[nfonts]; encodingOffset = new int[nfonts];
		 * charstringsOffset = new int[nfonts]; fdarrayOffset = new int[nfonts];
		 ...
		 * System.err.println("fnt strings = "+(stringOffsets.length-1)); for
		 * (char j=0; j<standardStrings.length+(stringOffsets.length-1); j++) {
		 * //seek(stringOffsets[j]); //strings[j] = ""; //for (int
		 * k=stringOffsets[j]; k<stringOffsets[j+1]; k++) { // strings[j] +=
		 * (char)getCard8(); //}
		 * System.err.println("j="+(int)j+" <? "+(standardStrings
		 * .length+(stringOffsets.length-1)));
		...
		for (int j = 0; j < topdictOffsets.length - 1; j++) {
			...
			if (fonts[j].privateOffset >= 0) {
				...
				while (getPosition() < fonts[j].privateOffset + fonts[j].privateLength) {
					getDictItem();
					if (key == "Subrs")
						// Add the private offset to the lsubrs since the offset
						// is
