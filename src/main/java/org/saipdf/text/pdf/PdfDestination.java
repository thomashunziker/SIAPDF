...
public class PdfDestination extends PdfArray {
	 ...
	 * Constructs a new <CODE>PdfDestination</CODE>.
	 * <P>
	 * If <VAR>type</VAR> equals <VAR>FITBH</VAR> / <VAR>FITBV</VAR>, the width
	 * / height of the bounding box of a page will fit the window of the Reader.
	 * The parameter will specify the y / x coordinate of the top / left edge of
	 * the window. If the <VAR>type</VAR> equals <VAR>FITH</VAR> or
	 * <VAR>FITV</VAR> the width / height of the entire page will fit the window
	 * and the parameter will specify the y / x coordinate of the top / left
	 * edge. In all other cases the type will be set to <VAR>FITH</VAR>.
	 * 
	 * @param type
	 *            the destination type
	 * @param parameter
	 ...
	 * the factor zoom. A negative value for any of the parameters left or top,
	 * or a zoom value of 0 specifies that the current value of that parameter
	 * is to be retained unchanged.
	 * 
	 * @param type
	 *            must be a <VAR>PdfDestination.XYZ</VAR>
	 * @param left
	 ...
	 * rectangle specified by the coordinates left, bottom, right, and top
	 ...
	 * the smaller of the two, centering the rectangle within the window in the
	 * other dimension.
	 * 
	 * @param type
	...
	/**
	 * Creates a PdfDestination based on a String. Valid Strings are for
	 * instance the values returned by SimpleNamedDestination: "Fit",
	 * "XYZ 36 806 0",...
	 * 
	 * @param dest
