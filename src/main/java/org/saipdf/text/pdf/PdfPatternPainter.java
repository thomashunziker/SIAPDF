...
public final class PdfPatternPainter extends PdfTemplate {
	...
	/**
	 * Tells you if this pattern is colored/uncolored (stencil = uncolored, you
	 * need to set a default color).
	 * 
	...
	/**
	 * Gets a duplicate of this <CODE>PdfPatternPainter</CODE>. All the members
	 * are copied by reference but the buffer stays different.
	 * 
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#setGrayFill(float)
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#resetGrayFill()
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#setGrayStroke(float)
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#resetGrayStroke()
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#setRGBColorFillF(float, float,
	 *      float)
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#resetRGBColorFill()
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#setRGBColorStrokeF(float,
	 *      float, float)
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#resetRGBColorStroke()
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#setCMYKColorFillF(float, float,
	 *      float, float)
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#resetCMYKColorFill()
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#setCMYKColorStrokeF(float,
	 *      float, float, float)
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#resetCMYKColorStroke()
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#addImage(org.saipdf.text.Image,
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#setCMYKColorFill(int, int, int,
	 *      int)
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#setCMYKColorStroke(int, int,
	 *      int, int)
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#setRGBColorFill(int, int, int)
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#setRGBColorStroke(int, int,
	 *      int)
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#setColorStroke(java.awt.Color)
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#setColorFill(java.awt.Color)
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#setColorFill(org.saipdf.text.pdf.PdfSpotColor,
	 *      float)
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#setColorStroke(org.saipdf.text.pdf.PdfSpotColor,
	 *      float)
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#setPatternFill(org.saipdf.text.pdf.PdfPatternPainter)
	 */
	...
	/**
	 * @see org.saipdf.text.pdf.PdfContentByte#setPatternStroke(org.saipdf.text.pdf.PdfPatternPainter,
	 *      java.awt.Color, float)
	 */
