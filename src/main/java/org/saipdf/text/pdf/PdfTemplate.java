...
public class PdfTemplate extends PdfContentByte {
	 ...
	 * template can be included in this template or in another template.
	 * Templates are only written to the output when the document is closed
	 * permitting things like showing text in the first page that is only
	 * defined in the last page.
	 * 
	 * @param writer
	 ...
	 * 
	 * @return the layer this template belongs to or <code>null</code> for no
	 *         layer defined
	 */
	...
	public PdfIndirectReference getIndirectReference() {
		// uncomment the null check as soon as we're sure all examples still
		// work
	...
	/**
	 * Gets a duplicate of this <CODE>PdfTemplate</CODE>. All the members are
