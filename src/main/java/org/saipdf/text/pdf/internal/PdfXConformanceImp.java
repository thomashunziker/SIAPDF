...
import org.saipdf.text.pdf.BaseFont;
import org.saipdf.text.pdf.ExtendedColor;
import org.saipdf.text.pdf.PatternColor;
import org.saipdf.text.pdf.PdfArray;
import org.saipdf.text.pdf.PdfDictionary;
import org.saipdf.text.pdf.PdfGState;
import org.saipdf.text.pdf.PdfImage;
...
import org.saipdf.text.pdf.PdfXConformanceException;
import org.saipdf.text.pdf.ShadingColor;
import org.saipdf.text.pdf.SpotColor;
...
public class PdfXConformanceImp implements PdfXConformance {
	 ...
	 * 
	 * @return true if the PDF has to be in conformance with any of the PDF/X
	 *         specifications
	 */
	...
	/**
	 * Business logic that checks if a certain object is in conformance with
	 * PDF/X.
	 * 
	 * @param writer
	 *            the writer that is supposed to write the PDF/X file
	 * @param key
	 *            the type of PDF/X conformance that has to be checked
	 * @param obj1
