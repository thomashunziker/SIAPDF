...
import org.saipdf.text.pdf.PRStream;
...
public class PdfTextExtractor {
	...
	/**
	 * The {@link TextProvidingRenderListener} that will receive render
	 * notifications and provide resultant text
	 */
	private final TextProvidingRenderListener renderListener;

	/**
	 * Creates a new Text Extractor object, using a
	 * {@link SimpleTextExtractingPdfContentRenderListener} as the render
	 * listener
	 * 
	 * @param reader
