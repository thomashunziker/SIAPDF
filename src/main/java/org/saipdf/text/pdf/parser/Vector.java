 ...
 * unrelated to the {@link java.util.Vector} class in the standard JRE. <br>
 * <br>
 * For many PDF related operations, the z coordinate is specified as 1 This is
 * to support the coordinate transformation calculations. If it helps, just
 * think of all PDF drawing operations as occurring in a single plane with z=1.
 */
public class Vector {
	 ...
	 * the Z axis will generally be set to 1. If you want to compute the length
	 * of a vector, subtract it from the origin first (this will set the Z axis
	 * to 0).
	 * 
	 * For example: <code>aVector.subtract(originVector).length();</code>
	 * 
	 ...
	 * useful without taking the square root. <br>
	 * <br>
