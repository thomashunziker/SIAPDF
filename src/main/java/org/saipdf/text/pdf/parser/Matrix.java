...
/**
 * Keeps all the values of a 3 by 3 matrix and allows you to do some math with
 * matrices.
 * 
 * @since 2.1.4
 */
public class Matrix {
	...
	/**
	 * multiplies this matrix by 'b' and returns the result See
	 ...
	 */
	public int hashCode() {
		// return Arrays.hashCode(vals); // JDK 5 code, replaced with the
		// following
