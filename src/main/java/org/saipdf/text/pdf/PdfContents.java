...
/**
 * <CODE>PdfContents</CODE> is a <CODE>PdfStream</CODE> containing the contents
 * (text + graphics) of a <CODE>PdfPage</CODE>.
 */
...
class PdfContents extends PdfStream {
	...
	/**
	 * Constructs a <CODE>PdfContents</CODE>-object, containing text and general
	 * graphics.
	 * 
	 * @param under
	 *            the direct content that is under all others
	 * @param content
	 *            the graphics in a page
	 * @param text
	 *            the text in a page
	 * @param secondContent
	 *            the direct content that is over all others
