...
class TrueTypeFontSubSet {
	 ...
	 * table and the value is an <CODE>int[3]</CODE> where position 0 is the
	 * checksum, position 1 is the offset from the start of the file and
	 ...
	 *            the glyphs used
	 * @param includeCmap
	 *            <CODE>true</CODE> if the table cmap is to be included in the
	 *            generated font
	 */
