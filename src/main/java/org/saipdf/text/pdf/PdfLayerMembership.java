...
/**
 * Content typically belongs to a single optional content group, and is visible
 * when the group is <B>ON</B> and invisible when it is <B>OFF</B>. To express
 * more complex visibility policies, content should not declare itself to belong
 * to an optional content group directly, but rather to an optional content
 * membership dictionary represented by this class.
 * 
...
public class PdfLayerMembership extends PdfDictionary implements PdfOCG {
	...
	/**
	 * Gets the <CODE>PdfIndirectReference</CODE> that represents this
	 * membership layer.
	 * 
	...
	/**
	 * Sets the visibility policy for content belonging to this membership
	 * dictionary. Possible values are ALLON, ANYON, ANYOFF and ALLOFF. The
	 * default value is ANYON.
	 * 
	 * @param type
	...
	/**
	 * Gets the dictionary representing the membership layer. It just returns
	 * <CODE>this</CODE>.
	 * 
