 ...
 * text, graphics, and images. A Page object is a leaf of the Pages tree.<BR>
 * This object is described in the 'Portable Document Format Reference Manual
 * version 1.3' section 6.4 (page 73-81)
 * 
 * @see PdfPages
 */
...
public class PdfPage extends PdfDictionary {
	 ...
	 * 
	 * @param mediaBox
	 *            a value for the <B>MediaBox</B> key
	 * @param resources
	 *            an indirect reference to a <CODE>PdfResources</CODE>-object
	 * @param rotate
	 *            a value for the <B>Rotate</B> key
	 */

	// PdfPage(PdfRectangle mediaBox, Rectangle cropBox, PdfIndirectReference
	// resources, PdfNumber rotate) {
	// super(PAGE);
	 ...
	 * 
	 * @param contents
	 *            an indirect reference to a <CODE>PdfContents</CODE>-object
	 */
