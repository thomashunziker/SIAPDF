...
import org.saipdf.text.pdf.hyphenation.Hyphenation;
import org.saipdf.text.pdf.hyphenation.Hyphenator;

/**
 * Hyphenates words automatically accordingly to the language and country. The
 * hyphenator engine was taken from FOP and uses the TEX patterns. If a language
...
public class HyphenationAuto implements HyphenationEvent {
	 ...
	 * @param country
	 *            the country ("GB" for Great-Britain or "none" for no country,
	 *            for example)
	 * @param leftMin
	 *            the minimum number of letters before the hyphen
	 * @param rightMin
