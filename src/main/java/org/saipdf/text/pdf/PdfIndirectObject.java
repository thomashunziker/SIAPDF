 ...
 * <P>
 * An <I>indirect object</I> is an object that has been labeled so that it can
 * be referenced by other objects. Any type of <CODE>PdfObject</CODE> may be
 * labeled as an indirect object.<BR>
 * An indirect object consists of an object identifier, a direct object, and the
 * <B>endobj</B> keyword. The <I>object identifier</I> consists of an integer
 * <I>object number</I>, an integer <I>generation number</I>, and the <B>obj</B>
 * keyword.<BR>
...
public class PdfIndirectObject {
	...
	/**
	 * Returns a <CODE>PdfIndirectReference</CODE> to this
