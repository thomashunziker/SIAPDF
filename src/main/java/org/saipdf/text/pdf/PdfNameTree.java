...
public class PdfNameTree {
	 ...
	 * 
	 * @param items
	 *            the item of the name tree. The key is a <CODE>String</CODE>
	 *            and the value is a <CODE>PdfObject</CODE>. Note that although
	 *            the keys are strings only the lower byte is used and no check
	 *            is made for chars with the same lower byte and different upper
	 *            byte. This will generate a wrong tree name.
	 * @param writer
	 *            the writer
	 * @throws IOException
	 *             on error
