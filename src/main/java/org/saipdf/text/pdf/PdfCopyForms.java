...
/**
 * Allows you to add one (or more) existing PDF document(s) to create a new PDF
 * and add the form of another PDF document to this new PDF.
 * 
 * @since 2.1.5
 */
public class PdfCopyForms implements PdfViewerPreferences, PdfEncryptionSettings {
	...
	/**
	 * Concatenates a PDF document selecting the pages to keep. The pages are
	 * described as a <CODE>List</CODE> of <CODE>Integer</CODE>. The page
	 * ordering can be changed but no page repetitions are allowed.
	 * 
	 * @param reader
	 *            the PDF document
	 * @param pagesToKeep
	...
	/**
	 * Concatenates a PDF document selecting the pages to keep. The pages are
	 * described as ranges. The page ordering can be changed but no page
	...
	/**
	 * Copies the form fields of this PDFDocument onto the PDF-Document which
	 * was added
	 * 
	 * @param reader
	 *            the PDF document
	...
	/**
	 * Opens the document. This is usually not needed as addDocument() will do
	 * it automatically.
	 */
	public void open() {
		fc.openDoc();
