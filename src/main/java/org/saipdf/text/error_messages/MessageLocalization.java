 ...
 */
package org.saipdf.text.error_messages;
 ...
 * org.saipdf.text.error_messages in the form language_country.lng. The
 * internal file encoding is UTF-8 without any escape chars, it's not a normal
 * property file. See en.lng for more information on the internal format.
 * 
...
public final class MessageLocalization {
	...
	/**
	 * Get a message with two parameters. The parameters will replace the
	 * strings "{1}", "{2}", "{3}", "{4}" found in the message.
	 * 
	 * @param key
	 *            the key to the message
	 * @param p1
	...
	/**
	 * Sets the language to be used globally for the error messages. The
	 * language is a two letter lowercase country designation like "en" or "pt".
	 * The country is an optional two letter uppercase code like "US" or "PT".
	 * 
	 * @param language
	 *            the language
	 * @param country
