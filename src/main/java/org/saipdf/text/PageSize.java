...
/**
 * The <CODE>PageSize</CODE>-object contains a number of rectangles representing
...
public class PageSize {
	...
	/**
	 * This method returns a Rectangle based on a String. Possible values are
	 * the the names of a constant in this class (for instance "A4",
	 * "LETTER",...) or a value like "595 842"
	 */
