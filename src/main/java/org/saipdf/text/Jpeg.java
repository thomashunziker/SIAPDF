...
/**
 * An <CODE>Jpeg</CODE> is the representation of a graphic element (JPEG) that
 * has to be inserted into the document
 * 
 * @see Element
 * @see Image
 */
...
public class Jpeg extends Image {
	 ...
	 * @param marker
	 *            an int
	 * @return a type: <VAR>VALID_MARKER</CODE>, <VAR>UNSUPPORTED_MARKER</VAR>
	 *         or <VAR>NOPARAM_MARKER</VAR>
	 */
	...
	/**
	 * This method checks if the image is a valid JPEG and processes some
	 * parameters.
	 * 
	 * @throws BadElementException
	 * @throws IOException
					...
					if (marker == M_APP2) {
						...
						if (byteapp2.length >= 14) {
							...
							if (app2.equals("ICC_PROFILE")) {
								...
								// some jpeg producers don't know how to count
								// to 1
								if (order < 1)
									order = 1;
								if (count < 1)
