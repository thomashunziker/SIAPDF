 ...
 * <CODE>Section</CODE>s, <CODE>Paragraph</CODE>s, <CODE>List</CODE> and/or
 * <CODE>Table</CODE>s.
 * <P>
 * Remark: you can not construct a <CODE>Section</CODE> yourself. You will have
 * to ask an instance of <CODE>Section</CODE> to the <CODE>Chapter</CODE> or
 * <CODE>Section</CODE> to which you want to add the new <CODE>Section</CODE>.
 * <P>
 * Example: <BLOCKQUOTE>
 * 
 * <PRE>
...
public class Section extends ArrayList implements TextElementArray, LargeElement {
	...
	/**
	 * The number of sectionnumbers that has to be shown before the section
	 * title.
	 */
	...
	/**
	 * This is the complete list of sectionnumbers of this section and the
	...
	/**
	 * Adds a <CODE>Paragraph</CODE>, <CODE>List</CODE> or <CODE>Table</CODE> to
	 * this <CODE>Section</CODE>.
	 * 
	 * @param index
	 *            index at which the specified element is to be inserted
	 * @param o
	 *            an object of type <CODE>Paragraph</CODE>, <CODE>List</CODE> or
	 *            <CODE>Table</CODE>=
	 * @throws ClassCastException
	 *             if the object is not a <CODE>Paragraph</CODE>,
	 *             <CODE>List</CODE> or <CODE>Table</CODE>
	 */
	...
	/**
	 * Adds a <CODE>Paragraph</CODE>, <CODE>List</CODE>, <CODE>Table</CODE> or
	 * another <CODE>Section</CODE> to this <CODE>Section</CODE>.
	 * 
	 * @param o
	 *            an object of type <CODE>Paragraph</CODE>, <CODE>List</CODE>,
	 *            <CODE>Table</CODE> or another <CODE>Section</CODE>
	 * @return a boolean
	 * @throws ClassCastException
	 *             if the object is not a <CODE>Paragraph</CODE>,
	 *             <CODE>List</CODE>, <CODE>Table</CODE> or <CODE>Section</CODE>
	 */
	 ...
	 * 
	 * @param collection
	 *            a collection of <CODE>Paragraph</CODE>s, <CODE>List</CODE>s
	 *            and/or <CODE>Table</CODE>s
	 * @return <CODE>true</CODE> if the action succeeded, <CODE>false</CODE> if
	 *         not.
	 * @throws ClassCastException
	 *             if one of the objects isn't a <CODE>Paragraph</CODE>,
	 *             <CODE>List</CODE>, <CODE>Table</CODE>
	 */
	...
	/**
	 * Creates a <CODE>Section</CODE>, adds it to this <CODE>Section</CODE> and
	 * returns it.
	 * 
	 * @param indentation
	...
	/**
	 * Creates a <CODE>Section</CODE>, add it to this <CODE>Section</CODE> and
	 * returns it.
	 * 
	 * @param title
	 *            the title of the new section
	...
	/**
	 * Sets the depth of the sectionnumbers that will be shown preceding the
	 * title.
	 * <P>
	 * If the numberdepth is 0, the sections will not be numbered. If the
	 * numberdepth is 1, the section will be numbered with their own number. If
	 * the numberdepth is higher (for instance x > 1), the numbers of x - 1
	...
	/**
	 * Sets the style for numbering sections. Possible values are
	 * NUMBERSTYLE_DOTTED: 1.2.3. (the default) or
	...
	/**
	 * Sets the bookmark title. The bookmark title is the same as the section
	 * title but can be changed with this method.
	 * 
	 * @param bookmarkTitle
	 *            the bookmark title
	 */
	 ...
	 * @param numbers
	 *            an <CODE>ArrayList</CODE>, containing the numbers of the
	 *            Parent
	 */
