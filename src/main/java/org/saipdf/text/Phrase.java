...
import org.saipdf.text.pdf.HyphenationEvent;


/**
 * A <CODE>Phrase</CODE> is a series of <CODE>Chunk</CODE>s.
 * <P>
 * A <CODE>Phrase</CODE> has a main <CODE>Font</CODE>, but some chunks within
 * the phrase can have a <CODE>Font</CODE> that differs from the main
 * <CODE>Font</CODE>. All the <CODE>Chunk</CODE>s in a <CODE>Phrase</CODE> have
 * the same <CODE>leading</CODE>.
 * <P>
 * Example: <BLOCKQUOTE>
 * 
 * <PRE>
...
public class Phrase extends ArrayList implements TextElementArray {
	...
	/**
	 * Constructs a <CODE>Phrase</CODE> with a certain <CODE>Chunk</CODE> and a
	 * certain leading.
	 * 
	 * @param leading
	 *            the leading
	...
	/**
	 * Constructs a <CODE>Phrase</CODE> with a certain <CODE>String</CODE> and a
	 * certain <CODE>Font</CODE>.
	 * 
	 * @param string
	 *            a <CODE>String</CODE>
	 * @param font
	...
	/**
	 * Constructs a <CODE>Phrase</CODE> with a certain leading and a certain
	 * <CODE>String</CODE>.
	 * 
	 * @param leading
	 *            the leading
	...
	/**
	 * Constructs a <CODE>Phrase</CODE> with a certain leading, a certain
	 * <CODE>String</CODE> and a certain <CODE>Font</CODE>.
	 * 
	 * @param leading
	 *            the leading
	 * @param string
	...
	/**
	 * Adds a <CODE>Chunk</CODE>, an <CODE>Anchor</CODE> or another
	 * <CODE>Phrase</CODE> to this <CODE>Phrase</CODE>.
	 * 
	 * @param index
	 *            index at which the specified element is to be inserted
	 * @param o
	 *            an object of type <CODE>Chunk</CODE>, <CODE>Anchor</CODE> or
	 *            <CODE>Phrase</CODE>
	 * @throws ClassCastException
	 *             when you try to add something that isn't a <CODE>Chunk</CODE>
	...
	public void add(int index, Object o) {
		...
		try {
			...
			} else if (element.type() == Element.PHRASE || element.type() == Element.ANCHOR || element.type() == Element.ANNOTATION
					|| element.type() == Element.TABLE || // line added by David
															// Freels
	...
	/**
	 * Adds a <CODE>Chunk</CODE>, <CODE>Anchor</CODE> or another
	 * <CODE>Phrase</CODE> to this <CODE>Phrase</CODE>.
	 * 
	 * @param o
	 *            an object of type <CODE>Chunk</CODE>, <CODE>Anchor</CODE> or
	 ...
	 * 
	 * @param collection
	 *            a collection of <CODE>Chunk</CODE>s, <CODE>Anchor</CODE>s and
	 *            <CODE>Phrase</CODE>s.
	 ...
	 * split between chunks in the wrong place.
	 * 
	 * @param chunk
	...
	protected boolean addChunk(Chunk chunk) {
		...
		if (size() > 0 && !chunk.hasAttributes()) {
			try {
				...
				if (!previous.hasAttributes() && (f == null || f.compareTo(previous.getFont()) == 0) && !"".equals(previous.getContent().trim())
						&& !"".equals(c.trim())) {
					previous.append(c);
					return true;
				}
	...
	/**
	 * Gets the font of the first <CODE>Chunk</CODE> that appears in this
	 * <CODE>Phrase</CODE>.
	 * 
	 ...
	 * because toString will return an ArrayList with the toString value of the
	 * Chunks in this Phrase.
	 */
	...
	/**
	 * Checks is this <CODE>Phrase</CODE> contains no or 1 empty
	 * <CODE>Chunk</CODE>.
	 * 
	 * @return <CODE>false</CODE> if the <CODE>Phrase</CODE> contains more than
	 *         one or more non-empty<CODE>Chunk</CODE>s.
	 */
	...
	/**
	 * Gets a special kind of Phrase that changes some characters into
