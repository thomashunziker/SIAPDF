...
/**
 * A class that implements <CODE>DocListener</CODE> will perform some actions
 * when some actions are performed on a <CODE>Document</CODE>.
 * 
 * @see ElementListener
 * @see Document
 * @see DocWriter
...
public interface DocListener extends ElementListener {
	 ...
	 * <P>
	 * The outputstream of every writer implementing <CODE>DocListener</CODE>
	 * will be closed.
	 */
	...
	/**
	 * Parameter that allows you to do left/right margin mirroring (odd/even
	 * pages)
	 * 
	...
	/**
	 * Parameter that allows you to do top/bottom margin mirroring (odd/even
	 * pages)
	 * 
