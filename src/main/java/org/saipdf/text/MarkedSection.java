...
/**
 * Wrapper that allows to add properties to a Chapter/Section object. Before
 * iText 1.5 every 'basic building block' implemented the MarkupAttributes
 * interface. By setting attributes, you could add markup to the corresponding
 * XML and/or HTML tag. This functionality was hardly used by anyone, so it was
 * removed, and replaced by the MarkedObject functionality.
 */
