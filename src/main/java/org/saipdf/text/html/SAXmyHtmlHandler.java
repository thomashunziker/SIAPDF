...
import org.saipdf.text.xml.SAXiTextHandler;
import org.saipdf.text.xml.XmlPeer;
	...
	public void startElement(String uri, String lname, String name, Attributes attrs) {
		...
		if (myTags.containsKey(name)) {
			...
			if (ElementTags.TABLE.equals(peer.getTag()) || ElementTags.CELL.equals(peer.getTag())) {
				...
				String value;
				if (ElementTags.TABLE.equals(peer.getTag()) && (value = p.getProperty(ElementTags.BORDERWIDTH)) != null) {
