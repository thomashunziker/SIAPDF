...
import org.saipdf.text.factories.RomanAlphabetFactory;


/**
 * A <CODE>List</CODE> contains several <CODE>ListItem</CODE>s.
 * <P>
 * <B>Example 1:</B> <BLOCKQUOTE>
 * 
 * <PRE>
 ...
 * reached. Will it start on a new line?</LI>
 * <LI>
 * Third line</LI>
 * </OL>
 * 
 * <B>Example 2:</B> <BLOCKQUOTE>
 * 
 * <PRE>
...
public class List implements TextElementArray {
	...
	/**
	 * This is the <CODE>ArrayList</CODE> containing the different
	 * <CODE>ListItem</CODE>s.
	 */
	...
	/**
	 * In case you are using numbered/lettered lists, this String is added
	 * before the number/letter.
	 * 
	 * @since iText 2.1.1
	 */
	protected String preSymbol = "";
	/**
	 * In case you are using numbered/lettered lists, this String is added after
	 * the number/letter.
	 * 
	 * @since iText 2.1.1
	 */
	 ...
	 * Constructs a <CODE>List</CODE>.
	 * <P>
	 * Remark: the parameter <VAR>symbolIndent</VAR> is important for instance
	 * when generating PDF-documents; it indicates the indentation of the
	 * listsymbol. It is not important for HTML-documents.
	 * 
	 * @param numbered
	 *            a boolean
	 * @param symbolIndent
	 ...
	 * 
	 * @return <CODE>true</CODE> if the list is numbered, <CODE>false</CODE>
	 *         otherwise.
	 */
	 ...
	 * 
	 * @return <CODE>true</CODE> if the list is lettered, <CODE>false</CODE>
	 *         otherwise.
	 */
	 ...
	 * 
	 * @return <CODE>true</CODE> if it is lowercase, <CODE>false</CODE>
	 *         otherwise.
	 */
	...
	/**
	 * Sets the String that has to be added after a number or letter in the list
	 * symbol.
	 * 
	 * @since iText 2.1.1
	 * @param postSymbol
	 *            the String that has to be added after a number or letter in
	 *            the list symbol.
	 */
	...
	/**
	 * Sets the String that has to be added before a number or letter in the
	 * list symbol.
	 * 
	 * @since iText 2.1.1
	 * @param preSymbol
	 *            the String that has to be added before a number or letter in
	 *            the list symbol.
	 */
