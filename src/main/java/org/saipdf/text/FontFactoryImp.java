 ...
 * ttf- and ttc-files to this class first and then create fonts in your code
 * using one of the getFont method without having to enter a path as parameter.
 * 
...
public class FontFactoryImp implements FontProvider {
	...
	/**
	 * This is a map of postscriptfontnames of True Type fonts and the path of
	 * their ttf- or ttc-file.
	 */
	 ...
	 * 
	 * @param attributes
	 *            the attributes of a <CODE>Font</CODE> object.
	 ...
	 *            recursively scan subdirectories if <code>true</true>
	 * @return the number of fonts registered
	 * @since 2.1.2
	 */
				...
				try {
					...
					if (file.isDirectory()) {
						...
						if (".afm".equals(suffix) || ".pfm".equals(suffix)) {
							/*
							 * Only register Type 1 fonts with matching .pfb
							 * files
							 */
