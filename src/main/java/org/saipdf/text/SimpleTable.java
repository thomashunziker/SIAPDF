...
import org.saipdf.text.pdf.PdfPTableEvent;
...
public class SimpleTable extends Rectangle implements PdfPTableEvent, TextElementArray {
	...
	/**
	 * A RectangleCell is always constructed without any dimensions. Dimensions
	 * are defined after creation.
	 */
	public SimpleTable() {
		super(0f, 0f, 0f, 0f);
		setBorder(BOX);
	 ...
	 * 
	 * @return a org.saipdf.text.Table object
	 * @throws BadElementException
	 */
	 ...
	 * 
	 * @return a org.saipdf.text.pdf.PdfPTable object
	...
	/**
	 * @see org.saipdf.text.pdf.PdfPTableEvent#tableLayout(org.saipdf.text.pdf.PdfPTable,
	 *      float[][], float[], int, int,
	 *      org.saipdf.text.pdf.PdfContentByte[])
	 */
	...
	/**
	 * @see org.saipdf.text.TextElementArray#add(java.lang.Object)
	 */
