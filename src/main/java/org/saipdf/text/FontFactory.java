 ...
 * ttf- and ttc-files to this static class first and then create fonts in your
 * code using one of the static getFont-method without having to enter a path as
 * parameter.
 * 
