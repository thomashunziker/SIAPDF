...
/**
 * The ExceptionConverter changes a checked exception into an unchecked
 * exception.
 */
public class ExceptionConverter extends RuntimeException {
	...
	/**
	 * Convert an Exception into an unchecked exception. Return the exception if
	 * it is already an unchecked exception or return an ExceptionConverter
	 * wrapper otherwise
	 * 
	 * @param ex
	...
	/**
	 * here we prefix, with s.print(), not s.println(), the stack trace with
	 * "ExceptionConverter:"
	 * 
	 * @param s
	 */
	...
	/**
	 * requests to fill in the stack trace we will have to ignore. We can't
	 * throw an exception here, because this method is called by the constructor
	 * of Throwable
	 * 
	 * @return a Throwable
	 */
