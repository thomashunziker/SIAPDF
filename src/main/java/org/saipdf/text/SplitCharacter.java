...
import org.saipdf.text.pdf.PdfChunk;
...
public interface SplitCharacter {
	...
	/**
	 * Returns <CODE>true</CODE> if the character can split a line. The
	 * splitting implementation is free to look ahead or look behind characters
	 * to make a decision.
	 * <p>
	 ...
	 * 
	 * @param start
	 *            the lower limit of <CODE>cc</CODE> inclusive
	 * @param current
	 *            the pointer to the character in <CODE>cc</CODE>
	 * @param end
	 *            the upper limit of <CODE>cc</CODE> exclusive
	 * @param cc
	 *            an array of characters at least <CODE>end</CODE> sized
	 * @param ck
	 *            an array of <CODE>PdfChunk</CODE>. The main use is to be able
	 *            to call {@link PdfChunk#getUnicodeEquivalent(int)}. It may be
