...
public final class PdfPatternPainter extends PdfTemplate {
	...
	/**
	 * @see com.itextpdf.text.pdf.PdfContentByte#setRGBColorFillF(float, float,
	 *      float)
	 */
	...
	/**
	 * @see com.itextpdf.text.pdf.PdfContentByte#setRGBColorStrokeF(float,
	 *      float, float)
	 */
	...
	/**
	 * @see com.itextpdf.text.pdf.PdfContentByte#setCMYKColorFillF(float, float,
	 *      float, float)
	 */
	...
	/**
	 * @see com.itextpdf.text.pdf.PdfContentByte#setCMYKColorStrokeF(float,
	 *      float, float, float)
	 */
	...
	/**
	 * @see com.itextpdf.text.pdf.PdfContentByte#addImage(com.itextpdf.text.Image,
	...
	/**
	 * @see com.itextpdf.text.pdf.PdfContentByte#setCMYKColorFill(int, int, int,
	 *      int)
	 */
	...
	/**
	 * @see com.itextpdf.text.pdf.PdfContentByte#setCMYKColorStroke(int, int,
	 *      int, int)
	 */
	...
	/**
	 * @see com.itextpdf.text.pdf.PdfContentByte#setRGBColorStroke(int, int,
	 *      int)
	 */
	...
	/**
	 * @see com.itextpdf.text.pdf.PdfContentByte#setColorFill(com.itextpdf.text.pdf.PdfSpotColor,
	 *      float)
	 */
	...
	/**
	 * @see com.itextpdf.text.pdf.PdfContentByte#setColorStroke(com.itextpdf.text.pdf.PdfSpotColor,
	 *      float)
	 */
